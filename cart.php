...
<html lang="en">
    <head>
        ...
        <title>T-Shirt for Biking And Formal Attire | Cart</title>
    </head>
    <body>
        <form method="post">
            <div class="container">
                <div class="row mt-5">
                    <div class="col-10">
                        <h1><i class="fa-brands fa-cotton-bureau"></i> Cart</h1>
                    </div>
                                    ...
                                    <?php foreach($_SESSION['cartItems'] as $key => $value): ?>
                                        <?php foreach($value as $color => $quantity): ?>
                                            ...
                                            <tr>                                        
                                                ...
                                                <td><a href="remove-confirm.php?<?php echo 'delkey=' . $key . '&c=' . $color . '&q=' . $quantity; ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php endforeach; ?>
